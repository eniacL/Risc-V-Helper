...
async function news(context, viewType, title) {
    ...
    const onDiskPath = vscode.Uri.file(path.join(context.extensionPath, 'resources/images/webview', 'uvmclassmap.png'));
...
//# sourceMappingURL=uvmMap.js.map